...
*/
#ifndef CELLRATEBININFO_H_
#define CELLRATEBININFO_H_
...
typedef boost::shared_ptr<CellRateBinInfo> CellRateBinInfoPtr;

}



#endif /* CELLRATEBININFO_H_ */
